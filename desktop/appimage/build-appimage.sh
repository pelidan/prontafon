...
if [ -f "$PROJECT_DIR/resources/icons/prontafon.png" ]; then
    ...
    convert -size 256x256 xc:blue -fill white -gravity center -pointsize 48 -annotate 0 "Prontafon" "$SCRIPT_DIR/AppDir/usr/share/icons/hicolor/256x256/apps/prontafon.png" 2>/dev/null || true
fi
